                      ...
                      {self ? (
                        <View>
                          <MenuOption value={0} customStyles={popoverOption}>
                            <Iconfont name={article.favorited ? "star-fill" : "star"} size={22} color={"#717171"} style={{ marginRight: 16 }} />
                            <Text style={styles.optionText}>{article.favorited ? "取消收藏" : "收藏"}</Text>
                          </MenuOption>
                          <MenuOption value={1} customStyles={popoverOption}>
                            <Iconfont name={"share-fill"} size={19} color={"#717171"} style={{ marginRight: 16 }} />
