...
import { StyleSheet, View, Image, Text, TouchableHighlight, Animated, Easing, Dimensions, Platform, TouchableOpacity } from "react-native";
            ...
            return (
                <View style={styles.container}>
                    ...
                    >
                        ...
                        <TouchableHighlight style={styles.button} underlayColor={"#f0f0f0"} onPress={this.cancel.bind(this)}>
    ...
    renderItem(item, i) {
        return (
            <View style={styles.tipContentView} key={i}>
                ...
                <TouchableOpacity key={i} onPress={this.choose.bind(this, i)}>
        ...
        if (this.state.hide) {
            if (entityList && entityList.length > 0) {
                ...
                if (len === 1) {
                    ...
                    this.setState(
                        { title: title, choose0: entityList[0], choose1: entityList[1], hide: false, tipTextColor: tipTextColor, aHeight: 236 },
                        this.in
                    );
                }
            }
