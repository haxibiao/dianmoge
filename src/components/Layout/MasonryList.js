...
export default class MasonryList extends React.Component<Props, State> {
  static defaultProps = {
    ...
    renderScrollComponent: (props: Props) => {
      if (props.onRefresh && props.refreshing != null) {
        return <ScrollView {...props} refreshControl={<RefreshControl refreshing={props.refreshing} onRefresh={props.onRefresh} />} />;
      }
  ...
  render() {
    const { renderItem, ListHeaderComponent, ListEmptyComponent, ListFooterComponent, keyExtractor, onEndReached, ...props } = this.props;
    let headerElement;
